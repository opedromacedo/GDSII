...
# Generated on: Fri Dec 12 00:01:02 -03 2025 (Fri Dec 12 03:01:02 UTC 2025)
...
set logfile fv/opdiv/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/opdiv -revised fv_map
...
add_search_path /home/xmen/PDK/xfab_xh018/xh018/cadence/v8_0/techLEF/v8_0_1_1 /home/xmen/PDK/xfab_xh018/xh018/diglibs/D_CELLS_HD/v3_0/LEF/v3_0_0 /home/xmen/PDK/xfab_xh018/xh018/diglibs/D_CELLS_HD/v3_0/liberty_LPMOS/v3_0_1/PVT_1_80V_range -library -both
read_library -liberty -both \
    /home/xmen/PDK/xfab_xh018/xh018/diglibs/D_CELLS_HD/v3_0/liberty_LPMOS/v3_0_1/PVT_1_80V_range/D_CELLS_HD_LPMOS_slow_1_62V_125C.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/opdiv.sv
elaborate_design -golden -root {opdiv} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/opdiv/fv_map.v.gz
...
#add_name_alias fv/opdiv/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.opdiv.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.opdiv.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.opdiv.rtl.fv_map.rpt
