...
build_model \
    ...
    -designsource	 $WORKDIR/opdiv.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/opdiv.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 opdiv_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_opdiv_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 opdiv_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_opdiv_atpg
...
check_log log_commit_tests_FULLSCAN_opdiv_atpg
