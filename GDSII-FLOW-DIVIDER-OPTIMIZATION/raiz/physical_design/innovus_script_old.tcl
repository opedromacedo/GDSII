...
# create_floorplan -site CoreSite -core_density_size 0.98 0.75
# create_floorplan \
#   -site CoreSite \
#   -die_size {0 0 400 400} \
#   -core_size {20 20 380 380}
create_floorplan \
  -site CoreSite \
  -core_density_size 0.96 1 30 30 30 30
...
add_rings -nets {VDD VSS} -type core_rings -follow core -layer {top Metal9 bottom Metal9 left Metal10 right Metal10} -width {top 0.7 bottom 0.7 left 0.7 right 0.7} -spacing {top 0.2 bottom 0.2 left 0.2 right 0.2} -offset {top 0.5 bottom 0.5 left 0.5 right 0.5} -center 0 -threshold 0 -jog_distance 0 -snap_wire_center_to_grid none
...
add_stripes \
  ...
  -start_from left \
  -start_offset 1 \
  -pad_core_ring_top_layer_limit Metal9 \
