...
set_preference attribute_summary_group "area constraint_type density exclusive_group_gap exclusive_group_type exclusive_groups is_floating members name obj_type parent power_domain rects"
...
set_preference attribute_summary_hport "base_name direction escaped_name hinst hnet hpin name obj_type original_name"
...
set_preference attribute_summary_hinst "area base_name bbox boundary dft_dont_scan dont_touch dont_touch_effective dont_touch_hports dont_touch_sources dont_use_cells dont_use_cells_effective escaped_name group hinsts hnets hpins hports ilm_inst insts is_ilm local_hinsts local_hnets local_hpins local_insts local_pins module name obj_type original_name parent partition power_domain power_dynamic power_internal power_leakage power_switching power_toggle_rate power_total read_only read_only_effective ref_name use_cells"
set_preference attribute_summary_route_rule "is_from_lib is_hard_spacing layer_rules min_cuts name obj_type via_defs"
set_preference attribute_summary_hpin "base_name boundary_feedthru constant depth direction dont_touch dont_touch_effective dont_touch_sources edge escaped_name hinst hnet hport is_boundary_duplicate is_boundary_feedback is_boundary_feedthru is_boundary_phase_inverted is_phase_inverted layer location name net obj_type original_name partition_pin place_status side width"
