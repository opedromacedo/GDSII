...
build_model \
  -workdir mydir \
  -designsource ../../synthesis/outputs/opdiv_correct_netlist_dft.v \
  -techlib ../lib/slow_vdd1v0_basiccells.v \
  -designtop opdiv_correct
build_testmode -workdir mydir -testmode FULLSCAN -assignfile  opdiv_correct.FULLSCAN.pinassign
